  ...
  <modal-layout>
    <template #title>
      <div class="search_container">
        ...
        <div>
          <ion-button @click="onSearch" v-if="isButton == searchBtnType.search"> 搜索</ion-button>
          <img v-if="isButton == searchBtnType.erweima" src="@/assets/search/ewma.png" alt="">
    ...
    <template #content>
      <div class="history_container">
        ...
        <div class="delete_history" @click="deleteHistory">
          <img src="@/assets/information/delete.png" alt="" />
          清除历史记录
        </div>
      </div>
    </template>
